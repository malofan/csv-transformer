...
class TtoptionsTransformerServiceProvider extends AbstractServiceProvider
{
    ...
    {
        $this->getContainer()->add(FromBadmData::class)->addTag(ToTtoptionsDataTransformer::TAG_NAME);
        $this->getContainer()->add(FromOptimaData::class)->addTag(ToTtoptionsDataTransformer::TAG_NAME);
        $this->getContainer()->add(FromVentaData::class)->addTag(ToTtoptionsDataTransformer::TAG_NAME);
